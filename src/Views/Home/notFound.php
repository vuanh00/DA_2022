...
<section class="error">
    ...
    <div class="error__content">
        <div class="error__message message">
            ...
            <p class="message__text">Rất tiếc, không tìm thấy trang bạn đang tìm ở đây. Liên kết bạn theo dõi có thể bị hỏng hoặc không còn tồn tại. Vui lòng thử lại hoặc xem của chúng tôi.</p>
        </div>
        <div class="error__nav e-nav">
            <a href="<?= WEBROOT ?>" target="_blanck" class="e-nav__link"></a>
        </div>
    </div>
    <!-- END Content -->
